...
@property (readwrite, copy, nonatomic) NSURL *more_info_url;
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (self)
    {
        ...
        _more_info_url = [[NSURL URLWithString:dictionary[@"more_info_url"]] copy];
    }
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.more_info_url forKey:NSStringFromSelector(@selector(more_info_url))];
}
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    NSURL *more_info_url = [aDecoder decodeObjectForKey:NSStringFromSelector(@selector(more_info_url))];
