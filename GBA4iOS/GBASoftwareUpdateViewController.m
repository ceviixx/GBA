...
@property (weak, nonatomic) IBOutlet UIImageView *gbaicon;
...
- (void)viewDidLoad
{
    ...
    self.gbaicon.layer.borderColor = UIColor.secondaryLabelColor.CGColor;
    self.gbaicon.layer.borderWidth = 0.5;
    self.gbaicon.layer.cornerRadius = 15.0;
    self.gbaicon.layer.masksToBounds = true;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        return 70 + [self.softwareUpdateDescriptionTextView sizeThatFits:CGSizeMake(CGRectGetWidth(self.view.bounds), FLT_MAX)].height + 20; // Add one to ensure iOS 7 UITextView displays all lines of text
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        NSLog(@"%@", self.softwareUpdate.more_info_url);
        [[UIApplication sharedApplication] openURL:self.softwareUpdate.more_info_url];
    }
